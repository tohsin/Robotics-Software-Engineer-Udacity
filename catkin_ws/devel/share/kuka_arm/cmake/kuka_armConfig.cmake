...
if("TRUE" STREQUAL "TRUE")
  set(kuka_arm_SOURCE_PREFIX /Users/elena/dev/Robotics-Software-Engineer-Udacity/catkin_ws/src/RoboND-Kinematics-Project/kuka_arm)
  set(kuka_arm_DEVEL_PREFIX /Users/elena/dev/Robotics-Software-Engineer-Udacity/catkin_ws/devel)
  set(kuka_arm_INSTALL_PREFIX "")
  set(kuka_arm_PREFIX ${kuka_arm_DEVEL_PREFIX})
else()
  set(kuka_arm_SOURCE_PREFIX "")
  set(kuka_arm_DEVEL_PREFIX "")
  set(kuka_arm_INSTALL_PREFIX /Users/elena/dev/Robotics-Software-Engineer-Udacity/catkin_ws/install)
...
if(NOT "/Users/elena/dev/Robotics-Software-Engineer-Udacity/catkin_ws/devel/include " STREQUAL " ")
  set(kuka_arm_INCLUDE_DIRS "")
  set(_include_dirs "/Users/elena/dev/Robotics-Software-Engineer-Udacity/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Harsh Pandya <harsh@electricmovement.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'kuka_arm' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'kuka_arm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/Users/elena/dev/Robotics-Software-Engineer-Udacity/catkin_ws/src/RoboND-Kinematics-Project/kuka_arm/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT kuka_arm_NUM_DUMMY_TARGETS)
      set(kuka_arm_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::kuka_arm::wrapped-linker-option${kuka_arm_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR kuka_arm_NUM_DUMMY_TARGETS "${kuka_arm_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::kuka_arm::wrapped-linker-option${kuka_arm_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND kuka_arm_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /Users/elena/dev/Robotics-Software-Engineer-Udacity/catkin_ws/devel/lib;/Users/elena/opt/miniconda3/envs/robostackenv/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(kuka_arm_EXPORTED_TARGETS ${${kuka_arm_dep}_EXPORTED_TARGETS})
endforeach()
